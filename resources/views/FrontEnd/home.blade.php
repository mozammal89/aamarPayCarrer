        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center">
                    <img src="{{asset('FrontEnd/images/front.png')}}" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        ...
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                </a><span class="teacher-field text-white">Director and CTO</span>
                                <ul class="list-inline py-4 social">
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Chief Operating Officer & CAMLCO</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Chief Operating Officer & CAMLCO</span>
                                <ul class="list-inline py-4 social">
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Vice President, Product & Engineering</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                </a><span class="teacher-field text-white">Vice President, Product & Engineering</span>
                                <ul class="list-inline py-4 social">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Plabon.jpg')}}" alt="team image" class="card-img-top">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Nagib Mahfuz Plabon</h5>
                                <span>Network & Infra Engineer</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Nagib Mahfuz Plabon</h5>
                                </a>
                                <span class="teacher-field text-white">Network & Infra Engineer</span>
                                <ul class="list-inline py-4 social">
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Software Engineer, Products & Engineering </span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Software Engineer, Products & Engineering </span>
                                <ul class="list-inline py-4 social">
                        ...
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <ul class="list-inline py-4 social">
                                    ...
                                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/arjuman-sreashtho-41598a1b4/" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Sajon.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Sazon Mahmud</h5>
                                <span>Software Engineer, Products & Engineering</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Sazon Mahmud</h5>
                                </a>
                                <span class="teacher-field text-white">Software Engineer, Products & Engineering</span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-facebook"></span></a></li>-->
                                    <li class="list-inline-item"><a href="https://bd.linkedin.com/in/lwsazon" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Executive, UI & UX Designer</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Executive, UI & UX Designer</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Head Of Merchant Management Dept.</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Head Of Merchant Management Dept.</span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="https://www.facebook.com/sanjidaali.liza" target="_blank"><span class="ti-facebook"></span></a></li> -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Sobnom.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Sobnom Mustary</h5>
                                <span>Senior Executive, Merchant Operation, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Sobnom Mustary</h5>
                                </a>
                                <span class="teacher-field text-white">Senior Executive, Merchant Operation, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Hafsa.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Hafsa Mahmud</h5>
                                <span>Senior Executive, Merchant Operation, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Hafsa Mahmud</h5>
                                </a>
                                <span class="teacher-field text-white">Senior Executive, Merchant Operation, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Sohana.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Sohana Shobnom</h5>
                                <span>Senior Executive, Key Account Management, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Sohana Shobnom</h5>
                                </a>
                                <span class="teacher-field text-white">Senior Executive, Key Account Management, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/sohanashobnom" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Shomorita.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Advocate Shomorita Sharmin</h5>
                                <span>Assistant Manager, Legal & Regulatory Compliance</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Advocate Shomorita Sharmin</h5>
                                </a>
                                <span class="teacher-field text-white">Assistant Manager, Legal & Regulatory Compliance</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Mostafa.png')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Mostafa Badrul Hasan</h5>
                                <span>Manager, Sales & Acquisition, Commercial Dept. </span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Mostafa Badrul Hasan</h5>
                                </a>
                                <span class="teacher-field text-white">Manager, Sales & Acquisition, Commercial Dept. </span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="https://www.facebook.com/MostafaRabbi/" target="_blank"><span class="ti-facebook"></span></a></li> -->
                                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/mostafa-badrul-hasan-2b171315" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Assistant Manager, Sales & Acquisition, Commercial Dept. </span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Assistant Manager, Sales & Acquisition, Commercial Dept. </span>
                                <ul class="list-inline py-4 social">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Suma.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Suma Akter</h5>
                        ...
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Suma Akter</h5>
                                </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Farjana.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Farjana Yasmin</h5>
                                <span>Executive, Sales & Acquisition, Commercial Dept.</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Farjana Yasmin</h5>
                                </a>
                                <span class="teacher-field text-white">Executive, Sales & Acquisition, Commercial Dept.</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Anisha.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Anisha Farzana</h5>
                                <span>Executive, Sales & Acquisition, Commercial Dept.</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Anisha Farzana</h5>
                                </a>
                                <span class="teacher-field text-white">Executive, Sales & Acquisition, Commercial Dept.</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Fabiha.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Noor Zannat Fabiha Aunnit</h5>
                                <span>Assistant Manager, Branding & Digital Marketing, Commercial Dept.</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Noor Zannat Fabiha Aunnit</h5>
                                </a>
                                <span class="teacher-field text-white">Assistant Manager, Branding & Digital Marketing, Commercial Dept.</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Ratri.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Afsana Ratri Mishu</h5>
                                <span>Executive, Branding & Corporate Sales, Commercial Dept.</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Afsana Ratri Mishu</h5>
                                </a>
                                <span class="teacher-field text-white">Executive, Branding & Corporate Sales, Commercial Dept.</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Head of Finance & Accounts</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Head of Finance & Accounts</span>
                                <ul class="list-inline py-4 social">
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Assistant Manager, Finance & Accounts</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Assistant Manager, Finance & Accounts</span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="https://www.facebook.com/shahidhossain26" target="_blank"><span class="ti-facebook"></span></a></li> -->
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Assistant Manager, Admin & Banking</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Assistant Manager, Admin & Banking</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Lutfey.jpeg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Sk. Lutfey Alahi</h5>
                                <span>Assistant Manager, People Care</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Sk. Lutfey Alahi</h5>
                                </a>
                                <span class="teacher-field text-white">Assistant Manager, People Care</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Executive , Digital Lending Operation </span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Executive , Digital Lending Operation </span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="https://www.facebook.com/mahabubbijoy333" target="_blank"><span class="ti-facebook"></span></a></li> -->
                                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/ramisha-fariha-095790191/" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            ...
                            <div class="card-body">
                                ...
                                <span>Assistant Manager, Merchant Care</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                ...
                                <span class="teacher-field text-white">Assistant Manager, Merchant Care</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Mazharul.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Mazharul Islam</h5>
                                <span>Senior Executive, Merchant Care, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Mazharul Islam</h5>
                                </a>
                                <span class="teacher-field text-white">Senior Executive, Merchant Care, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-facebook"></span></a></li> -->
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Mou.jpg')}}" alt="team image" class="img-fluid">
                            <div class="card-body">
                                <h5 class="teacher mb-0">Abida Sultana Mou</h5>
                                <span>Merchant Care Executive, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Abida Sultana Mou</h5>
                                </a>
                                <span class="teacher-field text-white">Merchant Care Executive, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="staff-member my-lg-3 my-md-3 my-sm-0" style="height: 92%">
                        <div class="card white-bg shadow-sm text-center border-0" style="height: 100%">
                            <img src="{{asset('FrontEnd/images/team/Reshma.jpg')}}" alt="team image" class="card-img-top">
                            <div class="card-body">
                                <h5 class="h5 teacher mb-0">Reshma Akter</h5>
                                <span>Merchant Care Executive, MMD</span>
                            </div>
                        </div>
                        <div class="overlay d-flex align-items-center justify-content-center">
                            <div class="overlay-inner">
                                <a href="#!" class="teacher-name">
                                    <h5 class="mb-0 teacher text-white">Reshma Akter</h5>
                                </a><span class="teacher-field text-white">Merchant Care Executive, MMD</span>
                                <ul class="list-inline py-4 social">
                                    <!-- <li class="list-inline-item"><a href="https://www.facebook.com/akil193" target="_blank"><span class="ti-facebook"></span></a></li> -->
                                    <li class="list-inline-item"><a href="#" target="_blank"><span class="ti-linkedin"></span></a></li>
                                </ul>
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-md-5">
                    <div class="contact-us-content">
                        ...
                        <br>
                        <span>Phone: 09643250250 (10 AM - 7 PM)</span> <br>
