(function ($) {
	...
	jQuery(document).on('ready', function () {
		...
		$('.burger-menu').on('click', function () {
			...
			toogler = !toogler;
			// $("#bigLogo").attr("hidden", false);
			// 	$("#smallLogo").attr("hidden", true);
		});
		...
		// $('.sidemenu-area').mouseenter(function () {
		// 	if(logoToogler){
		...
		// 		$("#bigLogo").attr("hidden", true);
		// 		$("#smallLogo").attr("hidden", false);
		// 	}
		// });
...
$(window).load(function () {
	...
	// document.getElementById('date-part').innerHTML = day + '-' + month[nMonth] + '-' + year + ' ';
	// startTime();
	//
	// function startTime() {
	// 	date = new Date;
	...
	// 	document.getElementById('time-part').innerHTML = strTime;
