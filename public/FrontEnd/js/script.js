...
function switchService(serviceID) {
	if (serviceID == 1) {
		$("#serv1Clk").removeClass('service-active');
		$("#serv2Clk").removeClass('service-active');
		$("#serv3Clk").removeClass('service-active');
		$("#serv4Clk").removeClass('service-active');
		$("#serv1Clk").addClass('service-active');
		$("#stil").attr('hidden', true);
		$("#aamarpay").attr('hidden', true);
		$("#muthofun").attr('hidden', true);
		$("#aamarpayApp").attr('hidden', true);
		$("#stil").removeAttr('hidden');
	} else if (serviceID == 2) {
		$("#serv1Clk").removeClass('service-active');
		$("#serv2Clk").removeClass('service-active');
		$("#serv3Clk").removeClass('service-active');
		$("#serv4Clk").removeClass('service-active');
		$("#serv2Clk").addClass('service-active');
		$("#stil").attr('hidden', true);
		$("#aamarpay").attr('hidden', true);
		$("#muthofun").attr('hidden', true);
		$("#aamarpayApp").attr('hidden', true);
		$("#aamarpay").removeAttr('hidden');
	} else if (serviceID == 3) {
		$("#serv1Clk").removeClass('service-active');
		$("#serv2Clk").removeClass('service-active');
		$("#serv3Clk").removeClass('service-active');
		$("#serv4Clk").removeClass('service-active');
		$("#serv3Clk").addClass('service-active');
		$("#stil").attr('hidden', true);
		$("#aamarpay").attr('hidden', true);
		$("#muthofun").attr('hidden', true);
		$("#aamarpayApp").attr('hidden', true);
		$("#muthofun").removeAttr('hidden');
	} else if (serviceID == 4) {
		$("#serv1Clk").removeClass('service-active');
		$("#serv2Clk").removeClass('service-active');
		$("#serv3Clk").removeClass('service-active');
		$("#serv4Clk").removeClass('service-active');
		$("#serv4Clk").addClass('service-active');
		$("#stil").attr('hidden', true);
		$("#aamarpay").attr('hidden', true);
		$("#muthofun").attr('hidden', true);
		$("#aamarpayApp").attr('hidden', true);
		$("#aamarpayApp").removeAttr('hidden');
	}
}
